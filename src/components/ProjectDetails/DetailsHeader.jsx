...
const buttonStyles = "bg-softBlue text-white w-[256px] rounded-full flex items-center justify-between gap-2 border px-4 py-1 h-[44px] text-sm hover:bg-softBlue hover:text-white transition duration-300";
const DetailsHeader = () => {
